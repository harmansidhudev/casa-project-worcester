...
export default function Contact() {
  return (
    <section id="contact" className="bg-blue-50 py-16 md:py-24 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4">Contact Us</h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Get in touch with us to learn more about volunteering, making a donation, or how you can support our mission to advocate for children in foster care.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">123 Main Street, Suite 200<br />Worcester, MA 01608</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">(508) 555-0123<br />Main Office</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">info@casaworcester.org<br />General Inquiries</p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg p-8 shadow-md">
            ...
            <form className="space-y-6" autoComplete="off">
              ...
              <button 
                type="submit" 
                className="w-full px-6 py-3 bg-blue-700 text-white rounded-lg font-semibold shadow-lg hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
